module mult32bit(a, b, prod); // synopsys template
	parameter width = 32;
	...
	fa add000(1'b0, a[0]&b[0], 1'b0, prod[0], c0[0]);
	fa add001(1'b0, a[1]&b[0], c0[0], s0[1], c0[1]);
	fa add002(1'b0, a[2]&b[0], c0[1], s0[2], c0[2]);
	fa add003(1'b0, a[3]&b[0], c0[2], s0[3], c0[3]);
	fa add004(1'b0, a[4]&b[0], c0[3], s0[4], c0[4]);
	fa add005(1'b0, a[5]&b[0], c0[4], s0[5], c0[5]);
	fa add006(1'b0, a[6]&b[0], c0[5], s0[6], c0[6]);
	fa add007(1'b0, a[7]&b[0], c0[6], s0[7], c0[7]);
	fa add008(1'b0, a[8]&b[0], c0[7], s0[8], c0[8]);
	fa add009(1'b0, a[9]&b[0], c0[8], s0[9], c0[9]);
	fa add010(1'b0, a[10]&b[0], c0[9], s0[10], c0[10]);
	fa add011(1'b0, a[11]&b[0], c0[10], s0[11], c0[11]);
	fa add012(1'b0, a[12]&b[0], c0[11], s0[12], c0[12]);
	fa add013(1'b0, a[13]&b[0], c0[12], s0[13], c0[13]);
	fa add014(1'b0, a[14]&b[0], c0[13], s0[14], c0[14]);
	fa add015(1'b0, a[15]&b[0], c0[14], s0[15], c0[15]);
	fa add016(1'b0, a[16]&b[0], c0[15], s0[16], c0[16]);
	fa add017(1'b0, a[17]&b[0], c0[16], s0[17], c0[17]);
	fa add018(1'b0, a[18]&b[0], c0[17], s0[18], c0[18]);
	fa add019(1'b0, a[19]&b[0], c0[18], s0[19], c0[19]);
	fa add020(1'b0, a[20]&b[0], c0[19], s0[20], c0[20]);
	fa add021(1'b0, a[21]&b[0], c0[20], s0[21], c0[21]);
	fa add022(1'b0, a[22]&b[0], c0[21], s0[22], c0[22]);
	fa add023(1'b0, a[23]&b[0], c0[22], s0[23], c0[23]);
	fa add024(1'b0, a[24]&b[0], c0[23], s0[24], c0[24]);
	fa add025(1'b0, a[25]&b[0], c0[24], s0[25], c0[25]);
	fa add026(1'b0, a[26]&b[0], c0[25], s0[26], c0[26]);
	fa add027(1'b0, a[27]&b[0], c0[26], s0[27], c0[27]);
	fa add028(1'b0, a[28]&b[0], c0[27], s0[28], c0[28]);
	fa add029(1'b0, a[29]&b[0], c0[28], s0[29], c0[29]);
	fa add030(1'b0, a[30]&b[0], c0[29], s0[30], c0[30]);
	fa add031(1'b0, a[31]&b[0], c0[30], s0[31], c0[31]);

	
	wire [width-1:0] c1, s1;

	fa add100(s0[1], a[0]&b[1], 1'b0, prod[1], c1[0]);
	...
	fa add131(1'b1, a[31]&b[1], c1[30], s1[31], c1[31]);

	
	wire [width-1:0] c2, s2;

	fa add200(s1[1], a[0]&b[2], 1'b0, prod[2], c2[0]);
	...
	fa add231(1'b1, a[31]&b[2], c2[30], s2[31], c2[31]);
	
	
	wire [width-1:0] c3, s3;

	fa add300(s2[1], a[0]&b[3], 1'b0, prod[3], c3[0]);
	...
	fa add331(1'b0, a[31]&b[3], c3[30], s3[31], c3[31]);
	
	
	wire [width-1:0] c4, s4;

	fa add400(s3[1], a[0]&b[4], 1'b0, prod[4], c4[0]);
	...
	fa add431(1'b0, a[31]&b[4], c4[30], s4[31], c4[31]);
	
	
	wire [width-1:0] c5, s5;

	fa add500(s4[1], a[0]&b[5], 1'b0, prod[5], c5[0]);
	...
	fa add531(1'b0, a[31]&b[5], c5[30], s5[31], c5[31]);
	
	
	wire [width-1:0] c6, s6;

	fa add600(s5[1], a[0]&b[6], 1'b0, prod[6], c6[0]);
	...
	fa add631(1'b0, a[31]&b[6], c6[30], s6[31], c6[31]);
	
	
	wire [width-1:0] c7, s7;

	fa add700(s6[1], a[0]&b[7], 1'b0, prod[7], c7[0]);
	...
	fa add731(1'b0, a[31]&b[7], c7[30], s7[31], c7[31]);
	
	
	wire [width-1:0] c8, s8;

	fa add800(s7[1], a[0]&b[8], 1'b0, prod[8], c8[0]);
	...
	fa add831(1'b0, a[31]&b[8], c8[30], s8[31], c8[31]);
	
	
	wire [width-1:0] c9, s9;

	fa add900(s8[1], a[0]&b[9], 1'b0, prod[9], c9[0]);
	...
	fa add931(1'b0, a[31]&b[9], c9[30], s9[31], c9[31]);
	
	
	wire [width-1:0] c10, s10;

	fa add1000(s9[1], a[0]&b[10], 1'b0, prod[10], c10[0]);
	...
	fa add1031(1'b0, a[31]&b[10], c10[30], s10[31], c10[31]);
		
	
	wire [width-1:0] c11, s11;

	fa add1100(s10[1], a[0]&b[11], 1'b0, prod[11], c11[0]);
	...
	fa add1131(1'b0, a[31]&b[11], c11[30], s11[31], c11[31]);
		
	
	wire [width-1:0] c12, s12;

	fa add1200(s11[1], a[0]&b[12], 1'b0, prod[12], c12[0]);
	...
	fa add1231(1'b0, a[31]&b[12], c12[30], s12[31], c12[31]);
		
	
	wire [width-1:0] c13, s13;

	fa add1300(s12[1], a[0]&b[13], 1'b0, prod[13], c13[0]);
	...
	fa add1331(1'b0, a[31]&b[13], c13[30], s13[31], c13[31]);
		
	
	wire [width-1:0] c14, s14;

	fa add1400(s13[1], a[0]&b[14], 1'b0, prod[14], c14[0]);
	...
	fa add1431(1'b0, a[31]&b[14], c14[30], s14[31], c14[31]);
		
	
	wire [width-1:0] c15, s15;

	fa add1500(s14[1], a[0]&b[15], 1'b0, prod[15], c15[0]);
	...
	fa add1531(1'b0, a[31]&b[15], c15[30], s15[31], c15[31]);
		
	
	wire [width-1:0] c16, s16;

	fa add1600(s15[1], a[0]&b[16], 1'b0, prod[16], c16[0]);
	...
	fa add1631(1'b0, a[31]&b[16], c16[30], s16[31], c16[31]);
		
	
	wire [width-1:0] c17, s17;

	fa add1700(s16[1], a[0]&b[17], 1'b0, prod[17], c17[0]);
	...
	fa add1731(1'b0, a[31]&b[17], c17[30], s17[31], c17[31]);
		
	
	wire [width-1:0] c18, s18;

	fa add1800(s17[1], a[0]&b[18], 1'b0, prod[18], c18[0]);
	...
	fa add1831(1'b0, a[31]&b[18], c18[30], s18[31], c18[31]);
		
	
	wire [width-1:0] c19, s19;

	fa add1900(s18[1], a[0]&b[19], 1'b0, prod[19], c19[0]);
	...
	fa add1931(1'b0, a[31]&b[19], c19[30], s19[31], c19[31]);
		
	
	wire [width-1:0] c20, s20;

	fa add2000(s19[1], a[0]&b[20], 1'b0, prod[20], c20[0]);
	...
	fa add2031(1'b0, a[31]&b[20], c20[30], s20[31], c20[31]);
	
		
	
	wire [width-1:0] c21, s21;

	fa add2100(s20[1], a[0]&b[21], 1'b0, prod[21], c21[0]);
	...
	fa add2131(1'b0, a[31]&b[21], c21[30], s21[31], c21[31]);
		
	
	wire [width-1:0] c22, s22;

	fa add2200(s21[1], a[0]&b[22], 1'b0, prod[22], c22[0]);
	...
	fa add2231(1'b0, a[31]&b[22], c22[30], s22[31], c22[31]);
		
	
	wire [width-1:0] c23, s23;

	fa add2300(s22[1], a[0]&b[23], 1'b0, prod[23], c23[0]);
	...
	fa add2331(1'b0, a[31]&b[23], c23[30], s23[31], c23[31]);
		
	
	wire [width-1:0] c24, s24;

	fa add2400(s23[1], a[0]&b[24], 1'b0, prod[24], c24[0]);
	...
	fa add2431(1'b0, a[31]&b[24], c24[30], s24[31], c24[31]);
			
	
	wire [width-1:0] c25, s25;

	fa add2500(s24[1], a[0]&b[25], 1'b0, prod[25], c25[0]);
	...
	fa add2531(1'b0, a[31]&b[25], c25[30], s25[31], c25[31]);
			
	
	wire [width-1:0] c26, s26;

	fa add2600(s25[1], a[0]&b[26], 1'b0, prod[26], c26[0]);
	...
	fa add2631(1'b0, a[31]&b[26], c26[30], s26[31], c26[31]);
			
	
	wire [width-1:0] c27, s27;

	fa add2700(s26[1], a[0]&b[27], 1'b0, prod[27], c27[0]);
	...
	fa add2731(1'b0, a[31]&b[27], c27[30], s27[31], c27[31]);
			
	
	wire [width-1:0] c28, s28;

	fa add2800(s27[1], a[0]&b[28], 1'b0, prod[28], c28[0]);
	...
	fa add2831(1'b0, a[31]&b[28], c28[30], s28[31], c28[31]);
			
	
	wire [width-1:0] c29, s29;

	fa add2900(s28[1], a[0]&b[29], 1'b0, prod[29], c29[0]);
	...
	fa add2931(1'b0, a[31]&b[29], c29[30], s29[31], c29[31]);
			
	
	wire [width-1:0] c30, s30;

	fa add3000(s29[1], a[0]&b[30], 1'b0, prod[30], c30[0]);
	...
	fa add3031(1'b0, a[31]&b[30], c30[30], s30[31], c30[31]);
			
	
	wire [width-1:0] c31, s31;

	fa add3100(s30[1], a[0]&b[31], 1'b0, prod[31], c31[0]);
	...
	fa add3131(1'b0, a[31]&b[31], c31[30], s31[31], c31[31]);
